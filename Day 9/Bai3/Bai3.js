...
function newQuote() {
    ...
    document.getElementById('quoteDisplayText').innerHTML=quotes[randomNum].quoteText;
    document.getElementById('quoteDisplayAuthor').innerHTML=quotes[randomNum].quoteAuthor;
}